...
eeqValue :: Interpreter i => Value -> Value -> i Value
eeqValue (VInt    u) (VInt    v) | u == v     = return $ VTrue
                                | otherwise = return $ VFalse
eeqValue (VDouble u) (VDouble v) | u == v     = return $ VTrue
                                | otherwise = return $ VFalse
eeqValue (VDouble u) (VInt    v) = eeqValue (VDouble u) (VDouble $ fromInteger v)
eeqValue (VInt    u) (VDouble v) = eeqValue (VDouble $ fromInteger u) (VDouble v)
eeqValue _ _ = fail $ "Internal error, trying to apply eeqValue to incompatible types."

eneqValue :: Interpreter i => Value -> Value -> i Value
eneqValue (VInt    u) (VInt    v) | u /= v     = return $ VTrue
                                | otherwise = return $ VFalse
eneqValue (VDouble u) (VDouble v) | u /= v     = return $ VTrue
                                | otherwise = return $ VFalse
eneqValue (VDouble u) (VInt    v) = eneqValue (VDouble u) (VDouble $ fromInteger v)
